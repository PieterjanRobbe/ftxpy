...
# ===================================================================
def get_root_dir():
    return os.path.join(os.environ["CSCRATCH"], "ftxpy", "convergence_test_low_burst_start_stop_8")
...
def define():
    ...
    for network_size in network_sizes():
        for seed in seeds():
            ...
            parameters["nImpacts"].set_value(100)
            parameters["netParam"].set_value(f"8 0 0 25 6 false")
            parameters["gridParam"].set_value(32)
            parameters["NPROC"].set_value(16)
            parameters["task_ppn"].set_value(8)
            ...
            slurm_settings["time_limit"] = 30
            slurm_settings["partition"] = "debug"
